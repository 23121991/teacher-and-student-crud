...
const handleSubmit= async (e)=>{
  ...
  setLoading(false);
    ...
    return (
    <>    
     <h1 className='stud_mange'>Student MANAGEMENT....!!!</h1>
     <h2 className='stud_mange_link'><Link to="/" element={<Dashboard />}>Dashboard</Link> | <Link to="/Liststudents" element={<Liststudents />}>View Student</Link></h2>
   
    <div className="col-md-6"></div>    
    <div className="container col-md-12">
    <h2 className='stud_header'>Create Student</h2>
    {loading && <div className='loading'>Loading</div>}
    {!loading && (
    
      <Form  className="allstuds" onSubmit={(e)=>handleSubmit(e)}>
