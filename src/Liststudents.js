...
const handleProceed = (id,status) => {
  ...
  async function onDeleteData(id){
    ...
    return (
        <>
         <h1 className='stud_heade'>List Of Students....!!!!</h1>
         <h6><Link to="/" element={<Dashboard />}>Dashboard</Link> |<Link to="/Createstudent" element={<Createstudent />}>Create Student</Link></h6>
         <h3 className='l_stud' >Students list</h3>
